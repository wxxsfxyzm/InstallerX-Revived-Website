...
::: warning Android 8.0 / 8.1 支持说明
26.09 将是最后一个支持 Android 8.0 和 8.1 的版本。后续版本的最低系统要求将提高至 Android 9。
:::
...
| :--- | :--- | :--- | :--- |
| **Android 14 - 17** | 34 - 37.0 | ✅ **完全支持** | 推荐使用以获得最佳体验。 |
...
InstallerX 现以单一 APK 发布。网络访问由应用设置控制；流式模式和签名限制请参阅[近期更新](./recent-updates.md)。
